...
public class Bunker {
    /** Cost of the bunker **/
    private int cost;
    /** Name of the bunker, ie Paleto Forest Bunker **/
    private String name;
    /** Coordinates of the bunker **/
    private Pair coordinates;
    /** The money output of the bunker **/
    private int money;
    ...
    protected int perPackage = 20;
    protected int stock = 1000;
    /** Based on the output($)/time(min) and upgrades **/
    protected int[][] output = {{500000, 600000, 700000}, {1000, 850, 700}};
     ...
     */
    public Bunker(int c, String bname, Pair coords, int[2] upgrades, int stock, int supp, int sell) {
        cost = c;
        name = bname;
        coordinates = coords;
     ...
     * @param coords Coordinates of the bunker
     */
    public Bunker(int c, String bname, Pair coords) {
        cost = c;
        name = bname;
        coordinates = coords;
        money = output[0][0];
